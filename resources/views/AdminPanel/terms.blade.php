    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manage The content of Terms of Use page</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Terms of Use Page</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form action="{{route('update.terms')}}" method="POST">
                                            ...
                                            <div class="text-center">
                                                <div class="row">
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <label class="control-label">the content of Terms of Use page (AR)</label>
                                                            <textarea class="form-control" id="message-text" name="termssectionAR">{{$Terms->terms_ar}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <label class="control-label">the content of Terms of Use page (EN)</label>
                                                            <textarea class="form-control" id="message-text1" name="termssectionEN">{{$Terms->terms_en}}</textarea>
                                                        </div>

                                                    </div>
                                                </div>
                                                <script>
                                                    CKEDITOR.replace('termssectionAR');
                                                    CKEDITOR.replace('termssectionEN');
                                                </script>
                                            </div>
