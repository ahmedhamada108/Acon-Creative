            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('privacypolice')}}" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Privacy Policy</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manage The content of Privacy Policy page</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Privacy Policy Page</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form action="{{route('update.privacy')}}" method="POST">
                                            ...
                                            <div class="text-center">
                                                <div class="row">
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <label class="control-label">the content of privacy Policy page (AR)</label>
                                                            <textarea class="form-control" id="message-text" name="pivacysectionAR">{{$Privacy->privacy_ar}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <label class="control-label">the content of privacy Policy page (EN)</label>
                                                            <textarea class="form-control" id="message-text1" name="privacysectionEN">{{$Privacy->privacy_en}}</textarea>
                                                        </div>

                                                    </div>
                                                </div>
                                                <script>
                                                    CKEDITOR.replace('pivacysectionAR');
                                                    CKEDITOR.replace('privacysectionEN');
                                                </script>
                                            </div>
