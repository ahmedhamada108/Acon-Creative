...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="../dist/img/logo@2x.png" alt="Acon-Creative" height="200" width="200">
    </div>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <!-- Main row -->
                <div class="row">
                    <div class="d-flex w-100 justify-content-center" style="margin-bottom: 24%;">
                        <img class="" src="../dist/img/logo@2x.png" alt="AdminLTELogo">
                    </div>
                </div>
