    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manage The Admins</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="{{route('add.admin')}}" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="recipient-name" name="nameadmin" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="recipient-name" class="col-form-label">Admin Email:</label>
                                                                <input type="email" class="form-control" id="recipient-name" name="emailadmin" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="recipient-name" class="col-form-label">Admin Password:</label>
                                                                <input type="password" class="form-control" id="recipient-name" name="passwordadmin" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="recipient-name" class="col-form-label">Confirm Password:</label>
                                                                <input type="password" class="form-control" id="recipient-name" name="conpasswordadmin" required>
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" role="menu" style="">
                                                                <a class="dropdown-item" href="{{route('editadmin.id',$admin->id)}}" data-toggle="modal" data-target="#editservice{{$admin->id}}">Edit</a>
                                                                <a class="dropdown-item" href="{{route('admin.delete',$admin->id)}}">Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    @endforeach
                                                    @foreach($data_admin as $admin)
                                                        <div class="modal fade"  id="editservice{{$admin->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel1">Edit this admin</h5>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form method="post" action="{{route('edit.admin',$admin->id)}}" >
                                                                            @csrf
                                                                            <div class="form-group">
                                                                                <label for="recipient-name" class="col-form-label">Admin Name :</label>
                                                                                <input type="text" class="form-control" id="recipient-name1" name="editnameadmin" value="{{$admin->name}}">
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="recipient-name" class="col-form-label">Admin email :</label>
                                                                                <input type="email" class="form-control" id="recipient-name1" name="editemailadmin" value="{{$admin->email}}">
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="recipient-name" class="col-form-label">Admin Password :</label>
                                                                                <input type="password" class="form-control" id="recipient-name1" name="editpasswordadmin" value="{{$admin->password}}">
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                <button type="submit" class="btn btn-primary">Edit this admin</button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
