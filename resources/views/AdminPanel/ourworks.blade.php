            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('ourworks')}}" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Our works</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manage The Our Works Section</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">All Our Works</h3>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="{{route('add.work')}}" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label for="recipient-name" class="col-form-label">Work name:</label>
                                                                <input type="text" class="form-control" id="recipient-name" name="name_work" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="file-text1" class="col-form-label">The image</label>
                                                                <input type="file" id="file-text1" accept="image/*" name="file" required>
                                                            </div>
                                    ...
                                    <div class="card-body">
                                        <table id="example2" class="table table-bordered table-hover">
                                          ...
                                          <tbody>
                                          @foreach($works as $Our_Works)
                                            <tr id="ourworks{{$Our_Works->id}}">
                                                <td>
                                                    <img src="../public/images/{{$Our_Works->img}}" height="50" width="50" style="border-radius: 30%;">
                                                </td>
                                                <td>{{$Our_Works->work_name}}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" role="menu" style="">
                                                            <a class="dropdown-item" href="{{route('editwork.id',$Our_Works->id)}}" data-toggle="modal" data-target="#editservice{{$Our_Works->id}}">Edit</a>
                                                            <a class="dropdown-item" href="{{route('work.delete',$Our_Works->id)}}">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                @endforeach
                                                @foreach($works as $Our_works)
                                                <div class="modal fade"  id="editservice{{$Our_works->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="post" action="{{route('work.edit',$Our_works->id)}}" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="form-group">
                                                                        <label for="recipient-name" class="col-form-label">the name of the work:</label>
                                                                        <input type="text" class="form-control" id="recipient-name1" name="editnamework" value="{{$Our_works->work_name}}">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="file-text" class="col-form-label">The image</label>
                                                                        <input id="file-text" type="file" accept="image/*" name="file" >
                                                                        <img src="../public/images/{{$Our_works->img}}" height="50" width="50" style="border-radius: 30%;">

                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                        <button type="submit" class="btn btn-primary">Edit this work</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
