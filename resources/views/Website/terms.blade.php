        ...
        @foreach($allcontent as $content)
            <div class="u-clearfix u-sheet u-sheet-1">
                @if(Str::substr(URL::current(),-2)=='EN')
                    <h1 class="u-align-center u-text u-text-custom-color-4 u-text-1" style="margin: 0 !important;">Terms of Use</h1>
                    ...
                    <h3 class="u-align-right u-text u-text-2" style="margin: 0 !important;">
                        @php echo htmlspecialchars_decode($content->terms_en); @endphp
                    </h3>
                @elseif(Str::substr(URL::current(),-2)=='AR')
                    <h1 class="u-align-center u-text u-text-custom-color-4 u-text-1"style="margin: 0 !important;">شروط الاستخدام</h1>
                    ...
                    <h3 class="u-align-center u-text u-text-2" style="margin: 0 !important;">
                        @php echo htmlspecialchars_decode($content->terms_ar); @endphp

                    </h3>
                @elseif(Str::substr(URL::current(),-2)=='AR')
                    <h1 class="u-align-right u-text u-text-custom-color-4 u-text-1"style="margin: 0 !important;">شروط الاستخدام</h1>
